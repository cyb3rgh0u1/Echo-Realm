...
<title>@yield('title', 'Echo-Realm') — The Resonance Awaits</title>
...
<nav class="nav" id="nav">
  <a href="{{ route('home') }}" class="nav-logo">Echo-Realm<small>The Resonance Awaits</small></a>
  <div class="nav-links">
    <a href="{{ route('home') }}" class="{{ request()->routeIs('home') ? 'active' : '' }}">Home</a>
    <a href="{{ route('characters.index') }}" class="{{ request()->routeIs('characters.*') ? 'active' : '' }}">Characters</a>
    <a href="{{ route('story.index') }}" class="{{ request()->routeIs('story.*') ? 'active' : '' }}">Story</a>
    <a href="{{ route('lore.index') }}" class="{{ request()->routeIs('lore.*') ? 'active' : '' }}">Lore</a>
  ...
  <div class="nav-end">
    <a href="{{ route('cart.index') }}" class="nav-cart" title="Cart">
      ...
      @if($cc > 0)<span class="nav-cart-count">{{ $cc }}</span>@endif
    </a>
    @auth
      <a href="{{ route('profile') }}" class="nav-btn nav-btn-ghost">{{ Str::limit(auth()->user()->name,14) }}</a>
      <form action="{{ route('logout') }}" method="POST" style="display:inline">
        @csrf<button type="submit" class="nav-btn-text">Logout</button>
      </form>
    @else
      <a href="{{ route('login') }}" class="nav-btn nav-btn-ghost">Login</a>
      <a href="{{ route('register') }}" class="nav-btn nav-btn-solid">Join</a>
    @endauth
  </div>
...
<div class="mob-nav" id="mob">
  ...
  <a href="{{ route('lore.index') }}">Lore</a>
...
<footer>
  <div class="footer-grid">
    ...
    <div class="footer-col">
      ...
      <ul>
        ...
        <li><a href="{{ route('story.index') }}">Story Arcs</a></li>
        <li><a href="{{ route('lore.index') }}">Lore Tomes</a></li>
    ...
    <div class="footer-col">
      <h4>Store</h4>
      <ul>
        <li><a href="{{ route('shop.index') }}">All Items</a></li>
        <li><a href="{{ route('shop.index') }}?type=game">Base Game</a></li>
        <li><a href="{{ route('shop.index') }}?type=bundle">Bundles</a></li>
        <li><a href="{{ route('shop.index') }}?type=currency">Currency</a></li>
      </ul>
    </div>
    <div class="footer-col">
      <h4>Account</h4>
  ...
  <div class="footer-bottom">
    <span>© {{ date('Y') }} Echo-Realm. All rights reserved.</span>
