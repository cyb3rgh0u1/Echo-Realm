        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" name="hero_eyebrow" class="form-control"
              value="<?php echo e($settings['hero_eyebrow'] ?? 'Decrypting Resonance Data'); ?>"
          ...
          <div class="form-group">
            ...
            <input type="text" name="hero_title" class="form-control"
              value="<?php echo e($settings['hero_title'] ?? 'Enter the Echo-Realm'); ?>"
          ...
          <div class="form-group">
            ...
            <input type="text" name="hero_title_sub" class="form-control"
              value="<?php echo e($settings['hero_title_sub'] ?? 'Shattered Reality'); ?>"
          ...
          <div class="form-group">
            ...
            <textarea name="hero_subtitle" class="form-control" rows="3"
              placeholder="Step into a universe where..."><?php echo e($settings['hero_subtitle'] ?? ''); ?></textarea>
          </div>
            ...
            <div>
              <div class="form-group">
                ...
                <input type="text" name="hero_btn1_text" class="form-control"
                  value="<?php echo e($settings['hero_btn1_text'] ?? 'Get the Game'); ?>" placeholder="Get the Game">
              </div>
              <div class="form-group">
                <label class="form-label">Button 1 — URL</label>
                <input type="text" name="hero_btn1_url" class="form-control"
                  value="<?php echo e($settings['hero_btn1_url'] ?? '/shop?type=game'); ?>" placeholder="/shop?type=game">
              </div>
            </div>
            <div>
              <div class="form-group">
                ...
                <input type="text" name="hero_btn2_text" class="form-control"
                  value="<?php echo e($settings['hero_btn2_text'] ?? 'Explore Story'); ?>" placeholder="Explore Story">
              </div>
              <div class="form-group">
                <label class="form-label">Button 2 — URL</label>
                <input type="text" name="hero_btn2_url" class="form-control"
                  value="<?php echo e($settings['hero_btn2_url'] ?? '/story'); ?>" placeholder="/story">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div style="display:flex;gap:0.5rem;flex-wrap:wrap">
              <?php $__currentLoopData = ['gradient'=>'Default Gradient','image'=>'Custom Image','video'=>'Background Video']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <label style="display:flex;align-items:center;gap:0.5rem;padding:0.45rem 1rem;border:1px solid var(--b1);border-radius:2px;cursor:pointer;font-size:0.75rem;transition:all 0.2s;user-select:none"
                     id="type-label-<?php echo e($val); ?>"
                     onclick="selectBgType('<?php echo e($val); ?>')">
                <input type="radio" name="hero_bg_type" value="<?php echo e($val); ?>"
                  <?php echo e(($settings['hero_bg_type'] ?? 'gradient') === $val ? 'checked' : ''); ?>

                  style="accent-color:var(--a);display:none" id="type-<?php echo e($val); ?>">
                <span id="type-dot-<?php echo e($val); ?>" style="width:8px;height:8px;border-radius:50%;border:1px solid var(--muted);flex-shrink:0;transition:all 0.2s"></span>
                <?php echo e($label); ?>
          ...
          <div class="form-group">
            <label class="form-label">
              Overlay Opacity
              <span id="overlay-val" style="color:var(--a2);margin-left:0.5rem"><?php echo e($settings['hero_bg_overlay'] ?? '0.55'); ?></span>
            </label>
            <input type="range" name="hero_bg_overlay" min="0" max="1" step="0.05"
              value="<?php echo e($settings['hero_bg_overlay'] ?? '0.55'); ?>"
          ...
          <div id="section-image" style="display:none">
            <div class="form-group">
              ...
              <?php $heroImg = $settings['hero_bg_image'] ?? ''; ?>
              <?php if($heroImg): ?>
              <div style="margin-bottom:0.75rem;position:relative;display:inline-block">
                <img src="<?php echo e(asset('storage/'.$heroImg)); ?>" alt="Hero BG"
          ...
          <div id="section-video" style="display:none">
            <div class="form-group">
              ...
              <?php $heroVid = $settings['hero_bg_video'] ?? ''; ?>
              <?php if($heroVid): ?>
              <div style="margin-bottom:0.75rem">
                <video src="<?php echo e(asset('storage/'.$heroVid)); ?>" style="max-height:100px;border-radius:2px;border:1px solid var(--b1)" muted></video>
                <div style="margin-top:0.4rem;display:flex;align-items:center;gap:0.5rem">
        ...
        <div class="card-body">
          <div class="form-grid">
            <div class="form-group">
              ...
              <input type="text" name="site_name" class="form-control" value="<?php echo e($settings['site_name']??'Echo-Realm'); ?>">
            </div>
            <div class="form-group">
              <label class="form-label">Tagline</label>
              <input type="text" name="site_tagline" class="form-control" value="<?php echo e($settings['site_tagline']??''); ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="form-label">Featured Banner Text</label>
            <input type="text" name="featured_banner" class="form-control" value="<?php echo e($settings['featured_banner']??''); ?>">
        ...
        <div class="card-body">
          <label class="form-check">
            <input type="checkbox" name="maintenance_mode" value="1"
              <?php echo e(($settings['maintenance_mode']??'0')==='1'?'checked':''); ?>>
    ...
    <div style="position:sticky;top:70px">
      <div class="card">
        ...
        <div style="position:relative;aspect-ratio:16/9;overflow:hidden;background:#020207">
          ...
          <img id="prev-image" src="<?php echo e($heroImg ? asset('storage/'.$heroImg) : ''); ?>"
            style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:none">
          <video id="prev-video" src="<?php echo e($heroVid ? asset('storage/'.$heroVid) : ''); ?>"
            autoplay loop muted playsinline
            style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:none"></video>
          <div id="prev-overlay" style="position:absolute;inset:0;background:rgba(0,0,0,<?php echo e($settings['hero_bg_overlay']??'0.55'); ?>)"></div>
          ...
          <div style="position:relative;z-index:2;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;padding:1.5rem;text-align:center;gap:0.5rem">
            <p id="prev-eyebrow" style="font-family:'Cinzel',serif;font-size:0.48rem;letter-spacing:0.4em;text-transform:uppercase;color:#a855f7;opacity:0.9">
              <?php echo e($settings['hero_eyebrow'] ?? 'Decrypting Resonance Data'); ?>
            ...
            <h2 id="prev-title" style="font-family:'Cinzel Decorative',serif;font-size:clamp(0.9rem,3vw,1.3rem);font-weight:900;line-height:1.1;color:#e4e0f0">
              <?php echo e($settings['hero_title'] ?? 'Enter the Echo-Realm'); ?>
            ...
            <span id="prev-title-sub" style="font-family:'Cinzel Decorative',serif;font-size:clamp(0.55rem,2vw,0.8rem);font-weight:700;background:linear-gradient(135deg,#c084fc,#f59e0b);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">
              <?php echo e($settings['hero_title_sub'] ?? 'Shattered Reality'); ?>
            ...
            <p id="prev-sub" style="color:#7a6f9a;font-size:0.5rem;line-height:1.6;max-width:220px;font-family:'Raleway',sans-serif;margin-top:0.25rem">
              <?php echo e(Str::limit($settings['hero_subtitle'] ?? '', 100)); ?>
            ...
            <div style="display:flex;gap:0.4rem;margin-top:0.4rem;flex-wrap:wrap;justify-content:center">
              <span id="prev-btn1" style="background:linear-gradient(135deg,#a855f7,#7c3aed);color:#fff;font-family:'Cinzel',serif;font-size:0.45rem;letter-spacing:0.1em;padding:0.3rem 0.75rem;border-radius:1px">
                <?php echo e($settings['hero_btn1_text'] ?? 'Get the Game'); ?>
              ...
              <span id="prev-btn2" style="border:1px solid rgba(168,85,247,0.4);color:#c084fc;font-family:'Cinzel',serif;font-size:0.45rem;letter-spacing:0.1em;padding:0.3rem 0.75rem;border-radius:1px">
                <?php echo e($settings['hero_btn2_text'] ?? 'Explore Story'); ?>
      ...
      <div class="card" style="margin-top:1rem">
        ...
        <div class="card-body" style="display:grid;gap:0.6rem">
          ...
          <div style="padding:0.6rem 0.75rem;background:var(--bg2);border-radius:2px;border:1px solid var(--b1)">
            <div style="font-family:var(--fh);font-size:0.6rem;letter-spacing:0.12em;color:var(--a2);margin-bottom:0.2rem"><?php echo e($k); ?></div>
            <div style="font-size:0.7rem;color:var(--muted);line-height:1.5"><?php echo e($v); ?></div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/admin/settings.blade.php ENDPATH**/ ?>