<?php $__env->startSection('title', $story->title); ?>
...
<div class="story-header">
  <div style="font-family:var(--font-heading); font-size:0.65rem; letter-spacing:0.4em; text-transform:uppercase; color:var(--gold); margin-bottom:1rem">
    Arc <?php echo e(sprintf('%02d', $story->arc_number)); ?> // File <?php echo e(sprintf('%03d', $story->chapter_number)); ?>
  ...
  <div style="display:flex; justify-content:center; align-items:center; gap:2rem; color:var(--text-dim); font-family:var(--font-heading); font-size:0.6rem; letter-spacing:0.2em; text-transform:uppercase">
    <span>Synchronizing... <?php echo e($story->status); ?></span>
  </div>
</div>
...
<div class="story-content-wrapper" id="storyContent">
  ...
  <div class="story-nav">
    <?php if($prev): ?>
    <a href="<?php echo e(route('story.show', $prev->slug)); ?>" class="nav-card">
      <span class="nav-label">
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><?php echo $icons['prev']; ?></svg>
        Previous File
      </span>
      <span class="nav-title"><?php echo e($prev->title); ?></span>
    </a>
    <?php else: ?>
    <div></div>
    <?php endif; ?>
    ...
    <?php if($next): ?>
    <a href="<?php echo e(route('story.show', $next->slug)); ?>" class="nav-card" style="align-items: flex-end; text-align: right">
      <span class="nav-label">
        Next File
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><?php echo $icons['next']; ?></svg>
      </span>
      <span class="nav-title"><?php echo e($next->title); ?></span>
    </a>
    <?php endif; ?>
  </div>

  <div style="text-align:center; margin-top:4rem">
    <a href="<?php echo e(route('story.index')); ?>" style="display:inline-flex; align-items:center; gap:10px; color:var(--text-dim); text-decoration:none; font-family:var(--font-heading); font-size:0.65rem; letter-spacing:0.2em; text-transform:uppercase">
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><?php echo $icons['all']; ?></svg>
      View All Narratives
    </a>
  </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/client/story/show.blade.php ENDPATH**/ ?>