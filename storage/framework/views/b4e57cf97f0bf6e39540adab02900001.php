...
<title><?php echo $__env->yieldContent('title','Dashboard'); ?> — Echo-Realm Admin</title>
...
<aside class="sb" id="sb">
  <div class="sb-logo">
    <a href="<?php echo e(route('admin.dashboard')); ?>">Echo-Realm<small>Admin Panel</small></a>
  </div>
  <a href="<?php echo e(route('home')); ?>" target="_blank" class="sb-site-link">
  ...
  <div class="sb-group">
    ...
    <ul class="sb-nav">
      <li>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'on' : ''); ?>">
  ...
  <div class="sb-group">
    ...
    <ul class="sb-nav">
      <li><a href="<?php echo e(route('admin.characters.index')); ?>" class="<?php echo e(request()->routeIs('admin.characters.*') ? 'on' : ''); ?>">
      ...
      <li><a href="<?php echo e(route('admin.elements.index')); ?>" class="<?php echo e(request()->routeIs('admin.elements.*') ? 'on' : ''); ?>">
      ...
      <li><a href="<?php echo e(route('admin.stories.index')); ?>" class="<?php echo e(request()->routeIs('admin.stories.*') ? 'on' : ''); ?>">
      ...
      <li><a href="<?php echo e(route('admin.lore.index')); ?>" class="<?php echo e(request()->routeIs('admin.lore.*') ? 'on' : ''); ?>">
      ...
      <li><a href="<?php echo e(route('admin.timeline.index')); ?>" class="<?php echo e(request()->routeIs('admin.timeline.*') ? 'on' : ''); ?>">
  ...
  <div class="sb-group">
    ...
    <ul class="sb-nav">
      <li><a href="<?php echo e(route('admin.shop.index')); ?>" class="<?php echo e(request()->routeIs('admin.shop.*') ? 'on' : ''); ?>">
      ...
      <li><a href="<?php echo e(route('admin.orders.index')); ?>" class="<?php echo e(request()->routeIs('admin.orders.*') ? 'on' : ''); ?>">
  ...
  <div class="sb-group">
    ...
    <ul class="sb-nav">
      <li><a href="<?php echo e(route('admin.users.index')); ?>" class="<?php echo e(request()->routeIs('admin.users.*') ? 'on' : ''); ?>">
      ...
      <li><a href="<?php echo e(route('admin.settings')); ?>" class="<?php echo e(request()->routeIs('admin.settings*') ? 'on' : ''); ?>">
  ...
  <div class="sb-foot">
    <div class="sb-ava"><?php echo e(strtoupper(substr(auth()->user()->name ?? 'A',0,1))); ?></div>
    <div style="flex:1;min-width:0">
      <div class="sb-uname"><?php echo e(auth()->user()->name ?? 'Admin'); ?></div>
...
<div class="main">
  <header class="topbar">
    <div class="topbar-left">
      ...
      <span class="page-head-title"><?php echo $__env->yieldContent('title','Dashboard'); ?></span>
    </div>
    <span class="topbar-date"><?php echo e(now()->format('d M Y')); ?></span>
  </header>
...
<?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/layouts/admin.blade.php ENDPATH**/ ?>