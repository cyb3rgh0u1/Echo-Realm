...
<div style="padding:10rem 2rem 8rem; max-width:900px; margin:0 auto; position:relative">
    ...
    <div class="profile-header" style="position:relative; z-index:1">
        ...
        <div class="profile-info">
            ...
            <div style="color:var(--text-muted); font-size:0.9rem; opacity:0.7; font-family:var(--font-heading); letter-spacing:0.05em">
                <span style="color:var(--accent-bright)">@</span><?php echo e($user->username); ?> 
        ...
        <div style="margin-left:auto">
            <a href="<?php echo e(route('orders.index')); ?>" class="btn btn-gold btn-sm" style="padding:0.7rem 1.75rem; display:inline-flex; align-items:center">
    ...
    <div class="stats-grid">
        ...
        <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $val, $svgPath]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="stat-card">
    ...
    <div class="details-panel">
        ...
        <div style="display:grid; gap:0.25rem">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value" style="color:var(--gold); font-family:monospace">@ <?php echo e($user->username); ?></span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><?php echo e($user->last_login_at ? $user->last_login_at->diffForHumans() : 'First initialization'); ?></span>
            </div>
        </div>
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/client/auth/profile.blade.php ENDPATH**/ ?>