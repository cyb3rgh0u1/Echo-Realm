...
<div class="auth-wrapper">
  <div class="auth-card">
    <div style="text-align:center;margin-bottom:2rem">
      ...
      <div style="color:var(--text-muted);font-size:0.85rem;margin-top:0.4rem">Welcome back. The Resonance remembers you.</div>
    </div>
...
unset($__errorArgs, $__bag); ?>
      ...
      <button type="submit" class="btn btn-primary" style="width:100%;justify-content:center">Enter the Realm</button>
    </form>
    <div style="text-align:center;margin-top:1.5rem;color:var(--text-muted);font-size:0.82rem">
      No account? <a href="<?php echo e(route('register')); ?>" style="color:var(--accent);text-decoration:none">Create one →</a>
    </div>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/client/auth/login.blade.php ENDPATH**/ ?>