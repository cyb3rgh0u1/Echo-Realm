...
<div class="section">
  <div class="container">
    <div class="filter-chips">
      <?php $noFilter = !request()->filled('category') && !request()->filled('classification'); ?>
      <a href="<?php echo e(route('lore.index')); ?>" class="filter-chip <?php echo e($noFilter ? 'active' : ''); ?>">All Archives</a>
      
      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <a href="<?php echo e(route('lore.index')); ?>?category=<?php echo e($cat); ?>" class="filter-chip <?php echo e(request('category') === $cat ? 'active' : ''); ?>">
        <?php echo e(ucfirst($cat)); ?>

      </a>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

      <a href="<?php echo e(route('lore.index')); ?>?classification=classified" class="filter-chip <?php echo e(request('classification') === 'classified' ? 'active' : ''); ?>" style="border-color: rgba(245,158,11,0.2)">
        <svg class="tome-icon" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2"><?php echo $svgs['classified']; ?></svg>
        Classified
      </a>

      <a href="<?php echo e(route('lore.index')); ?>?classification=top_secret" class="filter-chip <?php echo e(request('classification') === 'top_secret' ? 'active' : ''); ?>" style="border-color: rgba(239,68,68,0.2)">
        <svg class="tome-icon" viewBox="0 0 24 24" fill="none" stroke="var(--red)" stroke-width="2"><?php echo $svgs['top_secret']; ?></svg>
        Top Secret
      </a>
    </div>

    <div class="lore-grid">
      <?php $__empty_1 = true; $__currentLoopData = $lore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php
        ...
        <a href="<?php echo e(route('lore.show', $entry->slug)); ?>" class="lore-tome-card <?php echo e($status['card']); ?> reveal" style="transition-delay:<?php echo e(($i % 6) * 0.07); ?>s">
          
          <div class="status-badge" style="color:<?php echo e($status['color']); ?>; background:<?php echo e($status['color']); ?>11; border: 1px solid <?php echo e($status['color']); ?>33">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><?php echo $status['svg']; ?></svg>
          ...
          <div class="lore-footer">
            <div style="display:flex; gap:12px">
                <span style="display:flex; align-items:center; gap:5px">
                    <svg class="tome-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><?php echo $svgs['clock']; ?></svg>
                    <?php echo e($entry->read_time); ?>m
                </span>
                <span style="display:flex; align-items:center; gap:5px">
                    <svg class="tome-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><?php echo $svgs['calendar']; ?></svg>
    ...
    <div style="margin-top:3rem"><?php echo e($lore->links()); ?></div>
  </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/client/lore/index.blade.php ENDPATH**/ ?>