<?php $__env->startSection('title', $settings['hero_title'] ?? 'The Echo-Realm'); ?>
...
<section class="hero" id="hero-container" style="background: #000;">
    ...
    <?php if($bgType === 'image' && $bgImage): ?>
        <div style="position:absolute;inset:0;z-index:0">
            <img src="<?php echo e(asset('storage/'.$bgImage)); ?>" alt="" style="width:100%;height:100%;object-fit:cover;display:block">
            <div style="position:absolute;inset:0;background:rgba(0,0,0,<?php echo e($bgOverlay); ?>)"></div>
        </div>
    <?php elseif($bgType === 'video' && $bgVideo): ?>
        <div style="position:absolute;inset:0;z-index:0;overflow:hidden;background:#000;">
            ...
            <video id="heroVideo" 
                ...
                <source src="<?php echo e(asset('storage/'.$bgVideo)); ?>" type="video/mp4">
            </video>
            
            <div style="position:absolute;inset:0;background:rgba(0,0,0,<?php echo e($bgOverlay); ?>);z-index:1;"></div>
        </div>
    ...
    <div class="hero-content" id="hero-text-content" style="<?php echo e(($bgType === 'video') ? 'opacity:0;transform:translateY(30px);' : ''); ?> transition: all 1s cubic-bezier(0.23, 1, 0.32, 1) 0.5s;">
        <p class="hero-eyebrow"><?php echo e($eyebrow); ?></p>
        <h1 class="hero-title">
            <?php echo e($heroTitle); ?>

            <span><?php echo e($heroSub); ?></span>
        </h1>
        <p class="hero-sub"><?php echo e($heroPara); ?></p>
        <div class="hero-actions">
            <a href="<?php echo e($btn1Url); ?>" class="btn btn-gold"><?php echo e($btn1Text); ?></a>
            <a href="<?php echo e($btn2Url); ?>" class="btn btn-outline"><?php echo e($btn2Text); ?></a>
        </div>
    </div>
    ...
    <div class="banner-track">
        <?php $__currentLoopData = [
            ...
            <div class="banner-item">
                ...
                RESONANCE DETECTED: <?php echo e(strtoupper($text)); ?>
...
<section class="section-sm">
    <div class="container" style="text-align:center">
        ...
        <div class="elements-strip">
            <?php $__currentLoopData = \App\Models\Element::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('characters.index')); ?>?element=<?php echo e($el->id); ?>"
                   class="element-pill"
                   style="color:<?php echo e($el->color); ?>;border-color:<?php echo e($el->color); ?>55;background:<?php echo e($el->color); ?>0d">
                    <span><?php echo e($el->symbol); ?></span><?php echo e($el->name); ?>
...
<?php if($featuredCharacters->count()): ?>
<section class="section">
    <div class="container">
        <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:4rem" class="reveal">
            ...
            <a href="<?php echo e(route('characters.index')); ?>" class="btn btn-outline btn-sm">VIEW ALL FILES</a>
        </div>

        <div class="char-grid">
            <?php $__currentLoopData = $featuredCharacters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $char): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="char-card reveal" style="transition-delay:<?php echo e($i * 0.1); ?>s">

                
                <div class="char-img-wrap">
                    <div class="scanner-line"></div>
                    <?php if($char->image): ?>
                        <img src="<?php echo e(asset('storage/'.$char->image)); ?>" alt="<?php echo e($char->name); ?>"
                             style="width:100%;height:100%;object-fit:cover">
                    <?php else: ?>
                        <div class="char-img-placeholder">
                            <?php echo e($char->element ? $char->element->symbol : '⚔️'); ?>

                        </div>
                    <?php endif; ?>
                    <?php if($char->element): ?>
                        <div class="char-element-badge"
                             style="color:<?php echo e($char->element->color); ?>;border-color:<?php echo e($char->element->color); ?>">
                            <?php echo e($char->element->symbol); ?> <?php echo e($char->element->name); ?>
                ...
                <div class="char-body">
                    <div class="char-meta">
                        <span class="char-file-id">FILE_<?php echo e($char->id); ?></span>
                        <span class="badge badge-<?php echo e($char->rarity); ?>" style="font-size:0.55rem"><?php echo e(strtoupper($char->rarity)); ?></span>
                    </div>
                    <div class="char-name"><?php echo e($char->name); ?></div>
                    <?php if($char->title): ?>
                        <div class="char-title-sub"><?php echo e($char->title); ?></div>
                    <?php endif; ?>
                    <p class="char-bio"><?php echo e(Str::limit($char->bio, 110)); ?></p>

                    <div class="char-footer">
                        <span class="char-role-label"><?php echo e(ucfirst($char->role ?? '')); ?></span>
                        <a href="<?php echo e(route('characters.show', $char->slug)); ?>" class="char-link">
                            DECRYPT PROFILE
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><?php echo $svgs['arrow']; ?></svg>
                        </a>
                    </div>
                </div>
            </div>
...
<section class="section">
    <div class="container">
        <div class="story-preview reveal">
            <div>
                <p class="story-arc">ARC_<?php echo e($latestStory->arc_number); ?> // CHAPTER_<?php echo e($latestStory->chapter_number); ?> // LATEST_FILE</p>
                <h2 class="story-title"><?php echo e($latestStory->title); ?></h2>
                <p class="story-synopsis"><?php echo e($latestStory->synopsis); ?></p>
                <div style="display:flex;gap:1.5rem;flex-wrap:wrap">
                    <a href="<?php echo e(route('story.show', $latestStory->slug)); ?>" class="btn btn-gold">READ CHAPTER</a>
                    <a href="<?php echo e(route('story.index')); ?>" class="btn btn-outline">FULL ARCHIVE</a>
                </div>
            </div>
            <div class="story-visual">
                <svg width="200" height="200" viewBox="0 0 24 24" fill="none"
                     stroke="var(--gold)" stroke-width="0.5"><?php echo $svgs['read']; ?></svg>
            </div>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:4rem" class="reveal">
            ...
            <a href="<?php echo e(route('lore.index')); ?>" class="btn btn-outline btn-sm">ALL TOMES</a>
        </div>
        <div class="grid-3">
            <?php $__currentLoopData = $latestLore; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <a href="<?php echo e(route('lore.show', $entry->slug)); ?>"
                   class="lore-card reveal"
                   style="transition-delay:<?php echo e($i * 0.1); ?>s">
                    <div class="lore-category" style="color:<?php echo e($cColor); ?>">
                        <?php echo e(str_replace('_', ' ', strtoupper($entry->category))); ?>

                    </div>
                    <div class="lore-title"><?php echo e($entry->title); ?></div>
                    <p class="lore-excerpt"><?php echo e($entry->excerpt); ?></p>
                    <div class="lore-meta">
                        <span><?php echo e($entry->read_time); ?> min read</span>
                        <span>·</span>
                        <span style="color:<?php echo e($cColor); ?>"><?php echo e(str_replace('_', ' ', strtoupper($entry->classification))); ?></span>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="section">
    <div class="container">
        <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:4rem" class="reveal">
            ...
            <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-outline btn-sm">ALL ITEMS</a>
        </div>

        <div class="grid-4">
            <?php $__currentLoopData = $featuredShop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $icons = ['game'=>'🎮','character'=>'⚔️','skin'=>'✨','bundle'=>'📦','currency'=>'💎','consumable'=>'⚗️','cosmetic'=>'🎭'];
            ?>
            <div class="shop-card reveal" style="transition-delay:<?php echo e($i * 0.1); ?>s">
                <div class="shop-img">
                    <?php if($item->image): ?>
                    ...
                    <?php else: ?>
                        <?php echo e($icons[$item->type] ?? '🎮'); ?>

                    <?php endif; ?>
                    <?php if($item->discount_percent): ?>
                        <span class="shop-discount">-<?php echo e($item->discount_percent); ?>%</span>
                    <?php endif; ?>
                ...
                <div class="shop-body">
                    <div class="shop-type"><?php echo e($item->type); ?></div>
                    <div class="shop-name"><?php echo e($item->name); ?></div>
                    ...
                    <form action="<?php echo e(route('cart.add')); ?>" method="POST" style="margin:0">
                        ...
                        <button type="submit" class="btn btn-gold" style="width:100%;justify-content:center;gap:10px">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><?php echo $svgs['cart']; ?></svg>
                            ACQUIRE
                        </button>
                    </form>
                </div>
...
<section class="section" style="padding-bottom:10rem">
    <div class="container">
        <div class="cta-block reveal">
            ...
            <a href="<?php echo e(route('shop.index')); ?>?type=game"
               class="btn btn-gold"
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/echo-realm/resources/views/client/home/index.blade.php ENDPATH**/ ?>